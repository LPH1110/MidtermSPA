...
import styles from '../BookingFlight/BookingFlight.module.scss';
...
function Payment() {
    ...
    const handleSubmit = (data) => {
        setShowToast(true);
        setToastBody({ message: 'Payment successfully!', status: 'success' });
        setTimeout(() => {
            setShowToast(false);
        }, 3000);
    };
            ...
            <div>
                <Form>
                    ...
                    <header className="flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-semibold">Your Payment</h1>
                        ...
                        <div className="col-span-2 flex flex-col items-center">
                            <div className="mb-4 w-full rounded-lg shadow-[0_0_20px_0_rgba(148,163,184,0.3)]">
                                <div className="px-4 pt-4 pb-6 rounded-lg">
                                    <h1 className="text-xl font-semibold">Payment Infomation</h1>
                                    ...
                                    <div
                                        className={cx('form-row', 'min-h-[6rem] grid grid-cols-2 gap-x-4 items-center')}
                                    >
                                        <div className="relative mb-7">
                                            <div className={cx('input-container', 'bg-transparent relative py-2')}>
                                                <label htmlFor="email">
                                        ...
                                        <div className="grid grid-cols-3 gap-x-4">
                                            <div className="relative mb-7">
                                                ...
                                                <ErrorMessage name="countryCode">
                                                    {(message) => (
                                                        <span className="absolute top-full text-red-500">
                                                            {message}
                                                        </span>
                                                    )}
                                                </ErrorMessage>
                            ...
                            <div className="w-full text-left py-5 mt-5">
                                ...
                                <ul className="text-slate-500 list-disc p-5">
                                    <li className="py-1">
                                        For international flights or international transit, passport must be valid for
                                        at least 06 months before departure date.
                                    </li>
                                    <li className="py-1">
                                    ...
                                    <li className="py-1">
                                        Children from 14 days to under 02 years old need to be accompanied by an adult
                                        aged 18 or over.
                                    </li>
                                    <li className="py-1">
                                        The age of the child/baby will be calculated from the date of birth to the date
                                        of flight departure, based on the child's birth certificate/passport.
                                    </li>
                                    <li className="py-1">
